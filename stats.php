...
function displayStats( $main, $db, $navbar ){
   ...
   $selectYear = new selectYear($team->Team_ID);
   $main->set('content', $sql_Executor_Points->fetchThisTemplate("Stats.tpl.php",array(navbarstats => $navbar->fetch('templates/pages/statsnavbar.tpl.php'), selectYear => $selectYear->fetchYearOptions($_REQUEST['Year'], "Stats"))));
   echo $main->fetch('templates/pages/main.tpl.php'); 
