...
<ul>
   ...
   <li><h5>Team Administration for <?php echo$team->Team_Name?></h5></li>
      <ul>
         ...
         <?php if ( 1 != $team->Club ): ?>
         <!-- <li><button type="button" onClick="window.location='EnterAllStateNominations.php?Team_ID=<?php echo$team->Team_ID?>&Position_ID=1'">Enter All-State Nominations</button></li> -->
